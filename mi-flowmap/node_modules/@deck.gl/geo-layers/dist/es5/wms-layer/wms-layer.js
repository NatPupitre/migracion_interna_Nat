...
var projConverter = new _proj.Proj4Projection({
  from: 'EPSG:4326',
  to: 'EPSG:3857'
});
  ...
  (0, _createClass2.default)(WMSLayer, [{
    ...
    value: function () {
      var _loadImage = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee3(viewport, reason) {
        var _this$props, layers, serviceType, bounds, width, height, requestId, srs, requestParams, _projConverter$projec, _projConverter$projec2, minX, minY, _projConverter$projec3, _projConverter$projec4, maxX, maxY, image, _this$getCurrentLayer3, _this$getCurrentLayer4;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                if (srs === 'EPSG:3857') {
                  _projConverter$projec = projConverter.project([bounds[0], bounds[1]]), _projConverter$projec2 = (0, _slicedToArray2.default)(_projConverter$projec, 2), minX = _projConverter$projec2[0], minY = _projConverter$projec2[1];
                  _projConverter$projec3 = projConverter.project([bounds[2], bounds[3]]), _projConverter$projec4 = (0, _slicedToArray2.default)(_projConverter$projec3, 2), maxX = _projConverter$projec4[0], maxY = _projConverter$projec4[1];
